...
class AdminAssignmentGrid(Grid):
    ...
    def api(self, id=None):
        ...
        rows = [header] + [dict(
            cells=[
                dict(text=r["auth_credentials"]["name"]),
